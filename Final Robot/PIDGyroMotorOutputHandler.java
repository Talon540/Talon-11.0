...
public class PIDGyroMotorOutputHandler implements PIDOutput {
	private CANSD540 frontLeft, midLeft, backLeft, frontRight, midRight, backRight;
	double output;

	public PIDGyroMotorOutputHandler(CANSD540 frontLeft, CANSD540 midLeft, CANSD540 backLeft, CANSD540 frontRight,
	...
	/**
	 * Sets motor speed values. Positive values (should) turn right, negative left.
	 * 
	 * @param left
	 *            - left motor speed
	 * @param right
