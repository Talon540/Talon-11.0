...
public class Robot extends IterativeRobot {
	...
	SD540 frontLeft, frontRight, backLeft, backRight, midLeft, midRight, intake1, intake2, intakeVert, hook, winch;
	...
	public void robotInit() {
		...
		// wheel motors
		frontLeft = new SD540(3);
		midLeft = new SD540(4);
		backLeft = new SD540(5);
		frontRight = new SD540(0);
		midRight = new SD540(1);
		backRight = new SD540(2);

		// intake motors
		intake1 = new SD540(6);
		intake2 = new SD540(7);
		intakeVert = new SD540(8);

		// climber and winch NEED REAL PORT NUMBERS
		hook = new SD540(9);
		winch = new SD540(10);
